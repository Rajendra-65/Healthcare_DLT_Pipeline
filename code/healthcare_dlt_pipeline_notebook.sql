...
-- the keyword refresh means only newly data should be taken care of through checkpointing.
...
-- The below query is just like materalized view and  it does not have keyword refresh so it should re read data from the beigning
